...
import { TopicsTab } from './course-detail/TopicsTab';
import { AssignmentsTab } from './course-detail/AssignmentsTab';
import { LearningPathTab } from './course-detail/LearningPathTab';
import { RosterTab } from './course-detail/RosterTab';
import { AssessmentsTab } from './course-detail/AssessmentsTab';
...
export function TeacherCourseDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb items={[{ label: 'Courses', to: '/teacher/courses' }, { label: course.title }]} />
